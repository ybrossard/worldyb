...
set CLASSPATH=%PROJECT_DIRECTORY%\jar\home.jar

REM Lancement du programme de test TestDateUtils
java -classpath %CLASSPATH% -DCONF_DIR="D:\WorldYB\conf\main.properties" com.test.TestConfiguration